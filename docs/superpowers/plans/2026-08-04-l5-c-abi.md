...
- The 17 L5 handle/view object types (Tasks 2, 3, 6–13) carry
...
- Produces: C enum `jmap_vacation_state`, function `jmap_set_vacation`;
  Nim-private `func vacationUpdates` (the update-list construction) and
  `func fillFromVacationSet` (the NoCreate-shaped result fill).
