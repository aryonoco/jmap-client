...
### Task 14: The header gates — inventory (H18) and snapshot (H19)
...
- Modify: `justfile` (recipes `lint-c-header`, `snapshot-c-header`,
  `lint-c-header-snapshot`; extend `check` and `ci`)
- Modify: `.github/workflows/ci.yml`

**Interfaces:**
- Consumes: the complete exportc inventory (Tasks 1–13) and the
  complete header.
- Produces: the two gates every future L5 change runs under. H18 is a
