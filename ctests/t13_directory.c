...
static const char *THREAD_GET_JSON =
    "{\"methodResponses\":[[\"Thread/"
    "get\",{\"accountId\":\"A1\",\"state\":\"th-st1\",\"list\":[{\"id\":\"th-"
    "1\",\"emailIds\":[\"em-1\",\"em-2\"]}],\"notFound\":[]},\"c0\"]],"
    "\"sessionState\":\"s1\"}";
static const char *IDENTITY_GET_JSON =
    "{\"methodResponses\":[[\"Identity/"
    "get\",{\"accountId\":\"A1\",\"state\":\"id-st1\",\"list\":[{\"id\":"
    "\"449e1873-830a-4cbd-b884-c8fe8a16d36c\",\"name\":\"Alice\",\"email\":"
    "\"alice@example.com\",\"textSignature\":\"\",\"htmlSignature\":\"\","
    "\"mayDelete\":true}],\"notFound\":[]},\"c0\"]],\"sessionState\":\"s1\"}";
static const char *VACATION_GET_JSON =
    "{\"methodResponses\":[[\"VacationResponse/"
    "get\",{\"accountId\":\"A1\",\"state\":\"va-st1\",\"list\":[{\"id\":"
    "\"singleton\",\"isEnabled\":true,\"subject\":\"phase-b step-9 "
    "OOO\",\"textBody\":\"Out until next "
    "sprint.\"}],\"notFound\":[]},\"c0\"]],\"sessionState\":\"s1\"}";
...
static const char *BAD_VACATION_GET_JSON =
    "{\"methodResponses\":[[\"VacationResponse/"
    "get\",{\"accountId\":\"A1\",\"state\":\"va-st2\",\"list\":[{\"id\":"
    "\"singleton\",\"isEnabled\":true,\"subject\":\"phase-b step-9 "
    "OOO\",\"textBody\":\"Out until next "
    "sprint.\"},{\"id\":\"singleton\",\"isEnabled\":false}],\"notFound\":[]},"
    "\"c0\"]],\"sessionState\":\"s1\"}";

int main(void) {
  assert(jmap_init() == JMAP_OK);
  const char *bodies[] = {SESSION_JSON, THREAD_GET_JSON, IDENTITY_GET_JSON,
                          VACATION_GET_JSON, BAD_VACATION_GET_JSON};
