...
static const char *QUERY_JSON =
    ...
    "query\",{\"accountId\":\"A1\",\"queryState\":\"qs1\","
    "\"canCalculateChanges\":false,\"position\":0,\"ids\":[\"em-1\"]},\"c0\"],["
    "\"Email/"
    ...
    "text body\"}}}],\"notFound\":[]},\"c1\"]],\"sessionState\":\"s1\"}";
...
int main(void) {
  ...
  assert(jmap_query_set_u32(q, JMAP_Q_READ_STATE, JMAP_READ_UNREAD) == JMAP_OK);
  ...
  assert(jmap_query_set_u32(q2, JMAP_Q_READ_STATE, JMAP_READ_UNREAD) ==
         JMAP_OK);
  assert(jmap_query_set_u32(q2, JMAP_Q_READ_STATE, JMAP_READ_READ) == JMAP_OK);
