...
static const char *VACATION_SET_JSON =
    "{\"methodResponses\":[[\"VacationResponse/"
    "set\",{\"accountId\":\"A1\",\"oldState\":\"s1\",\"newState\":\"s2\","
    "\"updated\":{\"singleton\":null}},\"c0\"]],\"sessionState\":\"s1\"}";
static const char *VACATION_SET_REFUSED_JSON =
    "{\"methodResponses\":[[\"VacationResponse/"
    "set\",{\"accountId\":\"A1\",\"oldState\":\"s1\",\"newState\":\"s2\","
    "\"notUpdated\":{\"singleton\":{\"type\":\"invalidProperties\","
    "\"properties\":[\"textBody\"]}}},\"c0\"]],\"sessionState\":\"s1\"}";

int main(void) {
  assert(jmap_init() == JMAP_OK);
  const char *bodies[] = {SESSION_JSON, VACATION_SET_JSON, VACATION_SET_JSON,
  ...
  assert(jmap_vacation_update_set_enabled(u, JMAP_VACATION_ENABLED) == JMAP_OK);
  ...
  assert(strcmp(jmap_set_result_failure_type_at(r3, 0), "invalidProperties") ==
         0);
