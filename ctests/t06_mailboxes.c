...
static const char *MAILBOX_GET_JSON =
    "{\"methodResponses\":[[\"Mailbox/"
    "get\",{\"accountId\":\"A1\",\"state\":\"st2vq\",\"list\":[{\"id\":\"a\","
    "\"name\":\"Inbox\",\"parentId\":null,\"role\":\"inbox\",\"sortOrder\":0,"
    "\"isSubscribed\":true,\"totalEmails\":2043,\"unreadEmails\":2013,"
    "\"totalThreads\":1865,\"unreadThreads\":1835,\"myRights\":{"
    "\"mayReadItems\":true,\"mayAddItems\":true,\"mayRemoveItems\":true,"
    "\"maySetSeen\":true,\"maySetKeywords\":true,\"mayCreateChild\":true,"
    "\"mayRename\":true,\"maySubmit\":true,\"mayDelete\":true,\"mayShare\":"
    "true}},{\"id\":\"q\",\"name\":\"phase-i 49 "
    "charlie\",\"parentId\":\"a\",\"role\":null,\"sortOrder\":10,"
    "\"isSubscribed\":false,\"totalEmails\":0,\"unreadEmails\":0,"
    "\"totalThreads\":0,\"unreadThreads\":0,\"myRights\":{\"mayReadItems\":"
    "true,\"mayAddItems\":true,\"mayRemoveItems\":true,\"maySetSeen\":true,"
    "\"maySetKeywords\":true,\"mayCreateChild\":true,\"mayRename\":true,"
    "\"maySubmit\":true,\"mayDelete\":true,\"mayShare\":true}}],\"notFound\":[]"
    "},\"c0\"]],\"sessionState\":\"s1\"}";
...
int main(void) {
  ...
  for (size_t i = 0; i < jmap_mailboxes_count(mbs); i++) {
    ...
    if (jmap_mailbox_role_get(mb) == JMAP_ROLE_INBOX)
      inbox = mb;
  }
  assert(inbox != NULL);
