...
This project was developed with significant LLM involvement. I designed the logic, made technical decisions and directed development but AI/LLM tools generated most of the code. The design choices (e.g., Result types, domain entities, compiler settings, how `mail_builders.nim` entity overloads should be defined) are mine. Most of the code is generated by LLM tools.
