...
The design choices (Result types, domain entities, compiler settings, how should `mail_builders.nim` provide entity-specific overloads) are mine. Most of the code is generated by LLM tools.
