...
## Internal aggregator for Layer 2 mail serialisation modules. Used
## only by ``jmap_client/mail.nim`` (the public mail hub). Not a public
## path — see H10 internal-boundary lint.
