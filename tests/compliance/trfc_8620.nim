...
testCase rfc8620_S1_2_idCharsetBase64url:
...
testCase rfc8620_S1_2_idEveryBase64urlCharAccepted:
...
testCase rfc8620_S1_2_idSpaceRejected:
  ## Space (0x20) is not in the base64url alphabet.
  assertErr parseId("abc def")

testCase rfc8620_S1_2_idAtSignRejected:
...
testCase rfc8620_S1_3_unsignedIntLowerBound:
  ## UnsignedInt minimum value is 0.
  assertOk parseUnsignedInt(0'i64)

testCase rfc8620_S1_3_unsignedIntUpperBound:
...
testCase rfc8620_S1_3_jmapIntOverflowRejected:
...
testCase rfc8620_S1_4_zeroFractionalOmitted:
...
testCase rfc8620_S1_4_dateEmptyFractionalRejected:
  ## A dot with no following digits is rejected.
  assertErr parseDate("2024-01-01T12:00:00.Z")

testCase rfc8620_S1_4_dateHour24Accepted:
...
testCase rfc8620_S1_4_dateMinute60Accepted:
  ## Layer 1 validates structural format (correct digit positions, separators,
...
testCase rfc8620_S1_4_dateSecond60Accepted:
  ## Layer 1 validates structural format (correct digit positions, separators,
...
testCase rfc8620_S1_4_dateMonthZeroAccepted:
  ## Layer 1 validates structural format (correct digit positions, separators,
...
testCase rfc8620_S1_4_dateDayZeroAccepted:
  ## Layer 1 validates structural format (correct digit positions, separators,
...
testCase rfc8620_S1_4_dateYearZeroAccepted:
  ## Layer 1 validates structural format (correct digit positions, separators,
...
testCase rfc8620_S1_4_dateTwoDigitFrac:
  ## Layer 1 validates structural format (correct digit positions, separators,
...
testCase rfc8620_S1_6_2_accountIdLenientForServerAssigned:
...
testCase rfc8620_S1_8_vendorExtensionMapsToUnknown:
...
testCase rfc8620_S2_sessionRequiresCoreCapability:
...
testCase rfc8620_S2_sessionApiUrlNonEmpty:
...
testCase rfc8620_S2_sessionDownloadUrlVariables:
...
testCase rfc8620_S2_sessionUploadUrlVariable:
...
testCase rfc8620_S2_sessionEventSourceUrlVariables:
...
testCase rfc8620_S2_sessionValidConstructionSucceeds:
...
testCase rfc8620_S2_coreCapabilityUri:
...
testCase rfc8620_S2_sessionStatePreserved:
...
testCase rfc8620_S2_primaryAccountsCoreAccepted:
...
testCase rfc8620_S2_coreCapabilitiesAllEightFields:
...
testCase rfc8620_S3_2_invocationStructure:
...
testCase rfc8620_S3_2_methodCallIdCorrelation:
...
testCase rfc8620_S3_3_requestMethodCallsOrderPreserved:
...
testCase rfc8620_S3_3_requestCreatedIdsOptional:
  ## createdIds is optional; none is valid.
  let req = makeRequest()
  doAssert req.createdIds.isNone

testCase rfc8620_S3_3_requestCreatedIdsPresent:
...
testCase rfc8620_S3_4_responseMethodResponsesOrdering:
...
testCase rfc8620_S3_4_responseErrorInvocation:
...
testCase rfc8620_S3_6_1_rfc7807TypeField:
...
testCase rfc8620_S3_6_2_errorResponseNameConvention:
...
testCase rfc8620_S3_6_2_methodErrorMinimalFields:
...
testCase rfc8620_S3_6_2_setErrorMinimalFields:
...
testCase rfc8620_S3_7_resultReferenceConstruction:
...
testCase rfc8620_S3_7_referencableVariants:
...
testCase rfc8620_S3_7_resultReferenceTriple:
...
testCase rfc8620_S3_7_resultReferenceEmptyPath:
...
testCase rfc8620_S3_7_resultReferenceDoubleSeparator:
  ## RFC 8620 S3.7: the wire-boundary parser stores the path string as-is.
...
testCase rfc8620_S5_3_alreadyExistsMustIncludeExistingId:
...
testCase rfc8620_S5_3_creationIdOmitsHashPrefix:
  ## RFC S5.3: The '#' prefix is wire-format only. CreationId rejects it.
  assertErr parseCreationId("#abc")

testCase rfc8620_S5_3_creationIdAcceptsPlain:
...
testCase rfc8620_S5_5_filterOperators:
...
testCase rfc8620_S5_5_filterDeepNesting:
...
testCase rfc8620_S5_6_addedItemStructure:
...
testCase rfc8620_S9_4_allKnownCapabilitiesUseJmapUrnPrefix:
...
testCase rfc8620_S9_4_capabilityKindBijectiveRoundTrip:
...
testCase rfc8620_S1_2_idRejectsStandardBase64Chars:
  ## RFC 4648 S5: base64url excludes '+' and '/' from standard base64.
  assertErr parseId("abc+def")
  assertErr parseId("abc/def")

testCase rfc8620_S1_2_lenientRejectsNulDelTab:
...
testCase rfc8620_S3_2_responseDuplicateMethodCallId:
...
testCase rfc8620_S3_4_responseCreatedIdsMerged:
...
testCase rfc8620_S3_6_1_requestErrorAllRfc7807Fields:
...
testCase rfc8620_S5_3_setErrorDefensiveFallback:
...
testCase rfc8620_S1_4_dateWithPlusZeroOffset:
  ## Date with +00:00 offset is valid.
  assertOk parseDate("2024-01-15T10:30:00+00:00")

testCase rfc8620_S5_5_comparatorCollationDefault:
...
testCase rfc8620_crossRef_rfc4648_base64urlAlphabetSize:
...
testCase rfc8620_crossRef_rfc3339_leapSecond:
...
testCase rfc8620_S3_7_hashPrefixHandling:
...
testCase rfc8620_S2_downloadUrlMissingAccountId:
...
testCase rfc8620_S2_downloadUrlMissingBlobId:
...
testCase rfc8620_S2_downloadUrlMissingType:
...
testCase rfc8620_S2_downloadUrlMissingName:
...
testCase rfc8620_S2_eventSourceUrlMissingTypes:
...
testCase rfc8620_S2_eventSourceUrlMissingCloseafter:
...
testCase rfc8620_S2_eventSourceUrlMissingPing:
...
testCase rfc8620_S2_goldenSessionToJson:
...
testCase rfc8620_S3_3_goldenRequestToJson:
...
testCase rfc8620_S3_4_goldenResponseFromJson:
...
testCase rfc8620_S3_6_goldenLimitError:
...
testCase rfc8620_S3_6_goldenMethodError:
...
testCase rfc8620_S5_5_comparatorEmptyCollationWireSentinel:
...
testCase rfc8620_S1_4_leapSecondWithFractional:
...
testCase rfc8620_S3_6_1_requestErrorUnknownCapability:
...
testCase rfc8620_S3_6_1_requestErrorNotJSON:
...
testCase rfc8620_S3_6_2_serdeServerUnavailable:
...
testCase rfc8620_S5_3_serdeForbidden:
...
testCase rfc8620_S5_3_serdeAlreadyExists:
...
testCase rfc8621Section7ConstraintTableCompileTimeAnchor:
